...
esrnext_version = getVersion(jsonContent, "FIREFOX_ESR_NEXT")
...
if esrnext_version is not None:
    unlanded_esrnext_url = getReportURL("approval-mozilla-esr" + esrnext_version, cycle_span) + ";field0-0-0=cf_status_firefox_esr" + esrnext_version + ";type0-0-0=nowordssubstr;value0-0-0=unaffected,fixed,verified,wontfix,disabled" + ";field0-1-0=cf_tracking_firefox_esr" + esrnext_version + ";type0-1-0=equals;value0-1-0=%2B;field0-2-0=status_whiteboard;type0-2-0=notsubstring;value0-2-0=[no-nag]"
...
if esrnext_version is not None:
    tracking_esrnext_url = "https://bugzilla.mozilla.org/buglist.cgi?type0-1-0=nowordssubstr;field0-1-0=cf_status_firefox_esr" + esrnext_version + ";field0-0-0=cf_tracking_firefox_esr" + esrnext_version + ";value0-1-0=fixed%20verified%20disabled%20wontfix%20unaffected;type0-0-0=equals;value0-0-0=" + beta_version + "%2B;field0-2-0=status_whiteboard;type0-2-0=notsubstring;value0-2-0=[no-nag]"
...
if esrnext_version is not None:
    needinfo_esrnext_url = "https://bugzilla.mozilla.org/buglist.cgi?f1=cf_tracking_firefox_esr" + esrnext_version + "&v6=fixed%2Cwontfix%2Cunaffected%2Cverified%2Cdisabled&o1=anywords&resolution=---&o6=anywords&f12=flagtypes.name&v12=needinfo%3F&f11=OP&bug_status=UNCONFIRMED,NEW,READY,ASSIGNED,REOPENED&o12=equals&v1=%2B%2C%3F&f6=cf_status_firefox_esr" + esrnext_version + "&n6=1"
...
if esrnext_version is not None:
    urls += [
     (5, ["Unlanded ESR" + esrnext_version + " Bugs", "unlanded_esrnext", unlanded_esrnext_url]),
     (5, ["Tracked or Nominated for Tracking with Need-Info? ESR" + esrnext_version + " Bugs", "needinfo_esrnext", needinfo_esrnext_url]),
     (0, ["Bugs Tracked for ESR" + esrnext_version, "tracking_esrnext", tracking_esrnext_url]),
     ]
